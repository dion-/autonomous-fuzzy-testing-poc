...
import { calculateDiscount, capitalizeState, formatPhone } from "../utils/validators";
    ...
    <fieldset>
      ...
      <div className="divide-y divide-gray-100">
        ...
        <ReviewSection title="Shipping" onEdit={() => onEdit(1)}>
          ...
          <p>
            {data.shipping.city}, {capitalizeState(data.shipping.state)} {data.shipping.postalCode}
          </p>
